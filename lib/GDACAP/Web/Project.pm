...
my %known_action = map {$_ => 1} qw(list show create edit manage show_files show_file); 
...
sub list {
    ...
    my $content = {
        ...
        help_url               => $GDACAP::Web::location."/command/help/?id=projects",
    };
...
sub create {
	...
	my $content = {
		...
		help_url   => $GDACAP::Web::location.'/help/?id=project_create',            
